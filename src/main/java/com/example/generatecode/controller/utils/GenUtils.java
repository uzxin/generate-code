...
import com.example.generatecode.config.Constant;
import com.example.generatecode.domain.ColumnDO;
import com.example.generatecode.domain.TableDO;
import com.example.generatecode.exception.BusinessException;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/common/generator/reqVO.java.vm");
        templates.add("templates/common/generator/rspVO.java.vm");
        ...
        templates.add("templates/common/generator/WebController.java.vm");
        templates.add("templates/common/generator/AppController.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new BusinessException( 1, "渲染模板失败，表名：" + tableDO.getTableName() + e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new BusinessException( 1, "获取配置文件失败，"+ e);
        }
    }
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("reqVO.java.vm")) {
            return packagePath + "vo" + File.separator + className + "Req.java";
        }

        if (template.contains("rspVO.java.vm")) {
            return packagePath + "vo" + File.separator + className + "Rsp.java";
        }
        ...
        if (template.contains("WebController.java.vm")) {
            return packagePath + "controller" + File.separator + className + "WebController.java";
        }
...
//        }
        ...
        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator + "appjs" + File.separator
